...
<div class="sidebar">
    ...
    <div class="features">
     ...
     <a href="${pageContext.request.contextPath}/dashboard/hrManager/employee.jsp"><i class="fa-solid fa-users"></i>Employee</a>
     <a href="${pageContext.request.contextPath}/dashboard/employee/department.jsp"><i class="fa-solid fa-cube"></i> Department</a>
