...
<div class="content" id="main-content">
    ...
    <div class="row g-4 mb-5">
      ...
      <div class="col-md-3">
        <div class="card card-stat" id="card3" style="background: linear-gradient(45deg, #f6c23e, #dda20a);">
          <div class="card-body">
            <h3 class="fw-bold">Rs. 120,000,000</h3>
  ...
  <div class="calendar-card">
    ...
    <div class="row text-center mt-4">
      <div class="col-6 col-md-3"><span class="badge bg-primary me-1">&nbsp;</span> IT department:100</div>
      <div class="col-6 col-md-3"><span class="badge bg-warning me-1">&nbsp;</span>Operations:30 </div>
      <div class="col-6 col-md-3"><span class="badge bg-success me-1">&nbsp;</span> Finance department:50</div>
      <div class="col-6 col-md-3"><span class="badge bg-purple me-1" style="background-color:#6f42c1;">&nbsp;</span>HR department:20</div>
    </div>
