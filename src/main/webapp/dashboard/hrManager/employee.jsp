...
<div class="sidebar">
    ...
    <div class="features">
     ...
     <a href="${pageContext.request.contextPath}/dashboard/hrManager/department.jsp"><i class="fa-solid fa-cube"></i> Department</a>
        ...
        <div class="modal-body custom-scroll">
          ...
          <div class="row g-3 mb-3">
            <div class="col-md-6">
              ...
              <select class="form-select" name="department" id="updateDepartment" required>
                <option value="HR">HR</option>
                <option value="Finance">Finance</option>
                <option value="Development">Development</option>
              </select>
            ...
            <div class="col-md-6">
              ...
              <select class="form-select" name="role" id="updateRole" required>
                <option value="HR Manager">HR Manager</option>
                <option value="Supervisor">Supervisor</option>
                <option value="Financial Analyst">Financial Analyst</option>
                <option value="Employee">Regular Employee</option>
          ...
          <div class="row g-3 mb-3">
            <div class="col-md-6">
              ...
              <input type="date" class="form-control" name="dob" id="updateDob" required>
            </div>
            <div class="col-md-6">
              <label class="form-label d-block">Gender</label>
              <div class="form-check form-check-inline">
                <input class="form-check-input" type="radio" name="gender" value="Male" id="updateGenderMale">
                <label class="form-check-label" for="updateGenderMale">Male</label>
              </div>
              <div class="form-check form-check-inline">
                <input class="form-check-input" type="radio" name="gender" value="Female" id="updateGenderFemale">
                <label class="form-check-label" for="updateGenderFemale">Female</label>
              </div>
            </div>
          </div>
      ...
      <form method="post" action="${pageContext.request.contextPath}/EmployeeUpdateServlet">
        ...
        <div class="modal-body custom-scroll">
          <div class="mb-3">
            ...
            <input type="hidden" class="form-control" name="empId" id="empId" value="" required>
          </div>
          ...
          <div class="row g-3 mb-3">
            <div class="col-md-6">
              <label for="department" class="form-label">Department</label>
              <select class="form-select" name="department" id="department" value="" required>
                <option value="" selected disabled>Select one</option>
                <option value="HR">HR</option>
                <option value="Finance">Finance</option>
                <option value="Development">Development</option>
            ...
            <div class="col-md-6">
              <label for="role" class="form-label">Role</label>
              <select class="form-select" name="role" id="role" value="" required>
                <option value="" selected disabled>Select one</option>
                <option value="HR Manager">HR Manager</option>
                <option value="Supervisor">Supervisor</option>
                <option value="Financial Analyst">Financial Analyst</option>
