        ...
        <table class="table table-striped my-table">
            ...
            <tr>
                  ...
                  <td  style="display:flex; justify-content:center; align-items:center; gap:10px">                 
                  	...
                  	<i class="fa-regular fa-pen-to-square" id="update-icon" data-bs-toggle="modal" data-bs-target="#updateEmployeeModal" onclick="fillUpdateForm('<%= employee.getEmpId() %>', '<%= employee.getName()%>', '<%=employee.getEmail()%>', '<%=employee.getPhone()%>','<%=employee.getDepartment()%>', '<%= employee.getDob() %>', '<%= employee.getGender() %>', '<%= employee.getRole() %>', '<%= employee.getProfilePhoto() %>')"></i>
...
<div class="modal fade" id="addEmployeeModal" tabindex="-1" aria-labelledby="addEmployeeModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered modal-lg">
    <div class="modal-content">
      <form method="post" action="${pageContext.request.contextPath}/EmployeeInsertServlet" enctype="multipart/form-data">
